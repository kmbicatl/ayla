...
(function($) {
    ...
    var contxtBoxes = {
    	'formUserRoles':{box1View:'box11View',box1Storage:'box11Storage',box1Filter:'box11Filter',
    	box1Clear:'box11Clear',box1Counter:'box11Counter',
    	box2View:'box21View',box2Storage:'box21Storage',box2Filter:'box21Filter',
    	box2Clear:'box21Clear',box2Counter:'box21Counter',to1: 'to11',
            allTo1: 'allTo11',
            to2: 'to21',
            allTo2: 'allTo21'},
        'formRoleProducts':  {box1View:'box1View',box1Storage:'box1Storage',box1Filter:'box1Filter',
    	box1Clear:'box1Clear',box1Counter:'box1Counter',
    	box2View:'box2View',box2Storage:'box2Storage',box2Filter:'box2Filter',
    	box2Clear:'box2Clear',box2Counter:'box2Counter',to1: 'to1',
            allTo1: 'allTo1',
            to2: 'to2',
            allTo2: 'allTo2'},
		'formProductAPIs':  {box1View:'box31View',box1Storage:'box31Storage',box1Filter:'box31Filter',
    	box1Clear:'box31Clear',box1Counter:'box31Counter',
    	box2View:'box32View',box2Storage:'box32Storage',box2Filter:'box32Filter',
    	box2Clear:'box32Clear',box2Counter:'box32Counter',to1: 'to31',
            allTo1: 'allTo31',
            to2: 'to32',
            allTo2: 'allTo32'}              
    }
    //alert(_win.dualBoxActiveForm);
    if(!_win.dualBoxActiveForm){
    	_win.dualBoxActiveForm = 'formUserRoles';
    }
        var index = settings.push({
            box1View: contxtBoxes[_win.dualBoxActiveForm].box1View,
            box1Storage: contxtBoxes[_win.dualBoxActiveForm].box1Storage,
            box1Filter: contxtBoxes[_win.dualBoxActiveForm].box1Filter,
            box1Clear: contxtBoxes[_win.dualBoxActiveForm].box1Clear,
            box1Counter: contxtBoxes[_win.dualBoxActiveForm].box1Counter,
            box2View: contxtBoxes[_win.dualBoxActiveForm].box2View,
            box2Storage: contxtBoxes[_win.dualBoxActiveForm].box2Storage,
            box2Filter: contxtBoxes[_win.dualBoxActiveForm].box2Filter,
            box2Clear: contxtBoxes[_win.dualBoxActiveForm].box2Clear,
            box2Counter: contxtBoxes[_win.dualBoxActiveForm].box2Counter,
            to1: contxtBoxes[_win.dualBoxActiveForm].to1,
            allTo1: contxtBoxes[_win.dualBoxActiveForm].allTo1,
            to2: contxtBoxes[_win.dualBoxActiveForm].to2,
            allTo2: contxtBoxes[_win.dualBoxActiveForm].allTo2,
            transferMode: 'move',
            sortBy: 'text',
            useFilters: true,
            useCounters: true,
